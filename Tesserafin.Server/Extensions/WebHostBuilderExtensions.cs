...
public static class WebHostBuilderExtensions
{
    ...
    public static void SetupTesserafinWebServer(
        ...
        foreach (var netAdd in addresses)
        {
            ...
            if (httpsPort.HasValue)
            {
                ...
                else
                {
                    ...
                    {
                        throw new InvalidOperationException("Cannot run reefin with https without setting a valid certificate.");
                    }
