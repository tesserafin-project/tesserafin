...
using Tesserafin.Model.ApiClient;
...
namespace Tesserafin.Server.Filters
{
    ...
    public class AdditionalModelFilter : IDocumentFilter
    {
        ...
        private static readonly Type[] _ignoredConfigurations = [typeof(MigrationOptions), typeof(Tesserafin.Model.Branding.BrandingOptions)];
