...
/// omitting, for the <c>Tesserafin.Playback.Decision</c> vocabulary only.
/// </summary>
/// <remarks>
/// <para>
...
/// (<c>Tesserafin.Playback.Engine</c>, <c>.Dlna</c>, <c>.Execution</c>, <c>.Shadow</c>) are untouched.
...
public sealed class PlaybackDecisionRequiredSchemaFilter : ISchemaFilter
{
    ...
    /// </summary>
    public const string TargetNamespace = "Tesserafin.Playback.Decision";
