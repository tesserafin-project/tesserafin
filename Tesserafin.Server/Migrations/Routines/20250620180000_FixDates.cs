...
/// </summary>
[TesserafinMigration("2025-06-20T18:00:00", nameof(FixDates))]
public class FixDates : IAsyncMigrationRoutine
{
    ...
    /// <param name="dbProvider">Instance of the <see cref="IDbContextFactory{TesserafinDbContext}"/> interface.</param>
    public FixDates(
    ...
    private async Task FixBaseItemsAsync(TesserafinDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
    ...
    private async Task FixChaptersAsync(TesserafinDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
    ...
    private async Task FixBaseItemImageInfos(TesserafinDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
