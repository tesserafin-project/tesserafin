...
[TesserafinMigration("2025-04-20T10:00:00", nameof(MigrateUserDb), "5C4B82A2-F053-4009-BD05-B6FCAD82F14C")]
        ...
        using (var connection = new SqliteConnection($"Filename={userDbPath}"))
        {
            ...
            foreach (var entry in queryResult)
            {
                ...
                policy.AuthenticationProviderId = policy.AuthenticationProviderId?.Replace(
                    "Tesserafin.Server.Core.Library",
                    "Tesserafin.Server.Implementations.Users",
