...
/// </summary>
[TesserafinMigration("2026-05-22T09:23:04", nameof(UpdateNormalizedUsername), Stage = Stages.TesserafinMigrationStageTypes.CoreInitialisation)]
#pragma warning disable SA1649 // File name should match first type name
public class UpdateNormalizedUsername : IAsyncMigrationRoutine
#pragma warning restore SA1649 // File name should match first type name
{
    private readonly IDbContextFactory<TesserafinDbContext> _contextFactory;
    ...
    public UpdateNormalizedUsername(IDbContextFactory<TesserafinDbContext> contextFactory)
    {
