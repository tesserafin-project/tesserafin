...
/// </summary>
[TesserafinMigration("2025-04-20T21:00:00", nameof(MoveExtractedFiles))]
public class MoveExtractedFiles : IAsyncMigrationRoutine
{
    ...
    private bool MoveSubtitleAndAttachmentFiles(Guid id, string? path, ICollection<MediaStreamInfo>? mediaStreams, TesserafinDbContext context)
    {
