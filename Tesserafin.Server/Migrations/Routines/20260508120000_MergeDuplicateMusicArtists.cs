...
/// </summary>
[TesserafinMigration("2026-05-08T12:00:00", nameof(MergeDuplicateMusicArtists))]
[TesserafinMigrationBackup(TesserafinDb = true)]
public class MergeDuplicateMusicArtists : IAsyncMigrationRoutine
{
    private const string MusicArtistType = "Tesserafin.Controller.Entities.Audio.MusicArtist";
