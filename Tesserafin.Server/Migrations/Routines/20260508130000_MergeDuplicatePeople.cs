...
/// </summary>
[TesserafinMigration("2026-05-08T13:00:00", nameof(MergeDuplicatePeople))]
[TesserafinMigrationBackup(TesserafinDb = true)]
public class MergeDuplicatePeople : IAsyncMigrationRoutine
{
    private const string PersonType = "Tesserafin.Controller.Entities.Person";
    ...
    private async Task MergePersonBaseItemsAsync(TesserafinDbContext context, CancellationToken cancellationToken)
    {
    ...
    private async Task MergePeoplesRowsAsync(TesserafinDbContext context, CancellationToken cancellationToken)
    {
