...
internal class CodeMigration(Type migrationType, TesserafinMigrationAttribute metadata, TesserafinMigrationBackupAttribute? migrationBackupAttribute)
{
    public Type MigrationType { get; } = migrationType;

    public TesserafinMigrationAttribute Metadata { get; } = metadata;

    public TesserafinMigrationBackupAttribute? BackupRequirements { get; set; } = migrationBackupAttribute;
