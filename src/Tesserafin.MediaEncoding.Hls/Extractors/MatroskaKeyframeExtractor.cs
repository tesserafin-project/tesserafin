...
using Tesserafin.MediaEncoding.Keyframes;
using Extractor = Tesserafin.MediaEncoding.Keyframes.Matroska.MatroskaKeyframeExtractor;

namespace Tesserafin.MediaEncoding.Hls.Extractors;
