...
/// the legacy <c>Reefin.Database.Implementations.Enums.SubtitlePlaybackMode</c> (same member names
...
/// <c>Reefin.Server.Core.Library.MediaStreamSelector.GetDefaultSubtitleStreamIndex</c>
