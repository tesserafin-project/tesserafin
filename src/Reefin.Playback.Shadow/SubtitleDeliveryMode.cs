...
/// the legacy (<c>Reefin.Model.Dlna.SubtitleDeliveryMethod</c>) and v2
/// (<c>Reefin.Playback.Decision.SubtitleDeliveryMethod</c>) representations, mirroring the pattern
