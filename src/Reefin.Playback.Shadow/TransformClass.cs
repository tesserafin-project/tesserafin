...
/// (<c>Reefin.Playback.Decision.TransformKind</c>) representations. Mirrors
/// <c>Reefin.Playback.Decision.TransformKind</c> minus <c>CopyVideo</c>/<c>CopyAudio</c>, which carry
