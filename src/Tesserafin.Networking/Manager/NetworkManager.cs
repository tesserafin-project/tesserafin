...
namespace Tesserafin.Networking.Manager;
...
public class NetworkManager : INetworkManager, IDisposable
{
    ...
    /// <summary>
    /// Reads the reefin configuration of the configuration manager and produces a list of interfaces that should be bound.
    /// </summary>
    /// <param name="logger">Logger to use for messages.</param>
    ...
    /// <returns>A list of ip address of which reefin should bind to.</returns>
