...
using DomainPlaybackMethod = Tesserafin.Playback.Decision.PlaybackMethod;
using DomainStreamingProtocol = Tesserafin.Playback.Decision.StreamingProtocol;
using DomainSubtitleDeliveryMethod = Tesserafin.Playback.Decision.SubtitleDeliveryMethod;
using DomainTransformKind = Tesserafin.Playback.Decision.TransformKind;
...
/// existing HLS/ffmpeg execution machinery (<c>Tesserafin.Api.Helpers.StreamingHelpers.GetStreamingState</c>,
/// <c>Tesserafin.Controller.Streaming.StreamState</c>, <c>DynamicHlsController</c>, <c>VideosController</c>)
