...
public static class DescendantQueryHelper
{
    ...
    public static IQueryable<Guid> GetAllDescendantIds(ReefinDbContext context, Guid parentId)
    {
    ...
    public static IQueryable<Guid> GetOwnedDescendantIds(ReefinDbContext context, Guid parentId)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    public static HashSet<Guid> GetOwnedDescendantIdsBatch(ReefinDbContext context, IReadOnlyList<Guid> parentIds)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    public static IQueryable<Guid> GetFolderIdsMatching(ReefinDbContext context, FolderMatchCriteria criteria)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    private static HashSet<Guid> GetMatchingMediaStreamItemIds(ReefinDbContext context, HasMediaStreamType criteria)
    {
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyDown(ReefinDbContext context, ICollection<Guid> startIds)
    {
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyDownOwned(ReefinDbContext context, ICollection<Guid> startIds)
    {
        var visited = new HashSet<Guid>(startIds);
        var folderStack = new HashSet<Guid>(startIds);
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyUp(ReefinDbContext context, ICollection<Guid> startIds)
    {
