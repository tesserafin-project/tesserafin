...
/// <inheritdoc/>
/// <summary>
/// Initializes a new instance of the <see cref="ReefinDbContext"/> class.
/// </summary>
...
public class ReefinDbContext(DbContextOptions<ReefinDbContext> options, ILogger<ReefinDbContext> logger, IReefinDatabaseProvider reefinDatabaseProvider, IEntityFrameworkCoreLockingBehavior entityFrameworkCoreLocking) : DbContext(options)
{
    /// <summary>
    ...
    /// <summary>
    /// Repository for global::Reefin.Data.Entities.RatingSource - This is the entity to
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(ReefinDbContext).Assembly);
    }
