...
public sealed class ReefinDatabaseProviderKeyAttribute : System.Attribute
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReefinDatabaseProviderKeyAttribute"/> class.
    /// </summary>
    /// <param name="databaseProviderKey">The key on which to identify the annotated provider.</param>
    public ReefinDatabaseProviderKeyAttribute(string databaseProviderKey)
    {
