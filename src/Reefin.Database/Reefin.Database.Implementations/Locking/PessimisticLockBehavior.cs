...
namespace Reefin.Database.Implementations.Locking;
...
public class PessimisticLockBehavior : IEntityFrameworkCoreLockingBehavior
{
    ...
    /// <inheritdoc/>
    public void OnSaveChanges(ReefinDbContext context, Action saveChanges)
    {
    ...
    /// <inheritdoc/>
    public async Task OnSaveChangesAsync(ReefinDbContext context, Func<Task> saveChanges)
    {
        using (DbLock.EnterWrite(_logger))
        {
