...
/// </summary>
public interface IReefinDatabaseProvider
{
    /// <summary>
    /// Gets or Sets the Database Factory when initialisaition is done.
    /// </summary>
    IDbContextFactory<ReefinDbContext>? DbContextFactory { get; set; }
    ...
    Task PurgeDatabase(ReefinDbContext dbContext, IEnumerable<string>? tableNames);
}
