...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Reefin.Data.Entities.AncestorId", b =>
                {
            ...
            modelBuilder.Entity("Reefin.Data.Entities.AttachmentStreamInfo", b =>
                {
                    b.Property<Guid>("ItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.BaseItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.BaseItemImageInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.BaseItemMetadataField", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.BaseItemProvider", b =>
                {
                    b.Property<Guid>("ItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.BaseItemTrailerType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.Chapter", b =>
                {
                    b.Property<Guid>("ItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.CustomItemDisplayPreferences", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.ItemValue", b =>
                {
            ...
            modelBuilder.Entity("Reefin.Data.Entities.ItemValueMap", b =>
                {
                    b.Property<Guid>("ItemValueId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.MediaSegment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.MediaStreamInfo", b =>
                {
                    b.Property<Guid>("ItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.People", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.PeopleBaseItemMap", b =>
                {
                    b.Property<Guid>("ItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.Security.ApiKey", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.Security.Device", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.Security.DeviceOptions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.TrickplayInfo", b =>
                {
                    b.Property<Guid>("ItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.UserData", b =>
                {
                    b.Property<Guid>("ItemId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Reefin.Data.Entities.AncestorId", b =>
                {
                    b.HasOne("Reefin.Data.Entities.BaseItemEntity", null)
                        .WithMany("AncestorIds")
                        .HasForeignKey("BaseItemEntityId");

                    b.HasOne("Reefin.Data.Entities.BaseItemEntity", "Item")
                        .WithMany()
                        .HasForeignKey("ItemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Reefin.Data.Entities.BaseItemEntity", "ParentItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Reefin.Data.Entities.ItemValueMap", b =>
                {
                    ...
                    b.HasOne("Reefin.Data.Entities.ItemValue", "ItemValue")
            ...
            modelBuilder.Entity("Reefin.Data.Entities.PeopleBaseItemMap", b =>
                {
                    ...
                    b.HasOne("Reefin.Data.Entities.People", "People")
                        .WithMany("BaseItems")
            ...
            modelBuilder.Entity("Reefin.Data.Entities.Security.Device", b =>
                {
                    b.HasOne("Reefin.Data.Entities.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
