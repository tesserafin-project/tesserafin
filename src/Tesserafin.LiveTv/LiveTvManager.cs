...
using Tesserafin.LiveTv.Configuration;
...
namespace Tesserafin.LiveTv
{
    ...
    public class LiveTvManager : ILiveTvManager
    {
        ...
        private async Task<BaseItem[]> GetRecordingFoldersAsync(User user, bool refreshChannels)
        {
            ...
            var channels = await _channelManager.GetChannelsInternalAsync(new Tesserafin.Model.Channels.ChannelQuery
            {
                UserId = user.Id,
