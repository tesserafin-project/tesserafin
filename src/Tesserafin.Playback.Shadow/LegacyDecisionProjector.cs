...
/// <c>Tesserafin.Controller.MediaEncoding.IPlaybackSessionPlanner</c>, itself backed by
/// <c>Tesserafin.Model.Dlna.StreamBuilder</c> — into a <see cref="DecisionVector"/> comparable against
...
public static class LegacyDecisionProjector
{
    ...
    /// <summary>
    /// Maps the legacy <see cref="Tesserafin.Data.Enums.VideoRangeType"/> to the same string vocabulary
    /// v2's <see cref="Tesserafin.Playback.Decision.OutputSpec.VideoRange"/> uses (for example
