...
/// </summary>
public interface ITesserafinDatabaseProvider
{
    /// <summary>
    /// Gets or Sets the Database Factory when initialisaition is done.
    /// </summary>
    IDbContextFactory<TesserafinDbContext>? DbContextFactory { get; set; }
    ...
    /// <summary>
    /// If supported this should perform any actions that are required on stopping the reefin server.
    /// </summary>
    ...
    Task PurgeDatabase(TesserafinDbContext dbContext, IEnumerable<string>? tableNames);
}
