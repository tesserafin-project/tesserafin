...
using Tesserafin.Database.Implementations.MatchCriteria;
...
public static class DescendantQueryHelper
{
    ...
    public static IQueryable<Guid> GetAllDescendantIds(TesserafinDbContext context, Guid parentId)
    {
    ...
    public static IQueryable<Guid> GetOwnedDescendantIds(TesserafinDbContext context, Guid parentId)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    public static HashSet<Guid> GetOwnedDescendantIdsBatch(TesserafinDbContext context, IReadOnlyList<Guid> parentIds)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    public static IQueryable<Guid> GetFolderIdsMatching(TesserafinDbContext context, FolderMatchCriteria criteria)
    {
        ArgumentNullException.ThrowIfNull(context);
    ...
    private static HashSet<Guid> GetMatchingMediaStreamItemIds(TesserafinDbContext context, HasMediaStreamType criteria)
    {
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyDown(TesserafinDbContext context, ICollection<Guid> startIds)
    {
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyDownOwned(TesserafinDbContext context, ICollection<Guid> startIds)
    {
        var visited = new HashSet<Guid>(startIds);
        var folderStack = new HashSet<Guid>(startIds);
    ...
    /// </summary>
    private static HashSet<Guid> TraverseHierarchyUp(TesserafinDbContext context, ICollection<Guid> startIds)
    {
