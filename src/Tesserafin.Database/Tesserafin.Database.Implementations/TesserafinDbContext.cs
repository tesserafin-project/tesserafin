...
using Tesserafin.Database.Implementations.Interfaces;
...
/// <inheritdoc/>
/// <summary>
/// Initializes a new instance of the <see cref="TesserafinDbContext"/> class.
/// </summary>
/// <param name="options">The database context options.</param>
/// <param name="logger">Logger.</param>
/// <param name="reefinDatabaseProvider">The provider for the database engine specific operations.</param>
/// <param name="entityFrameworkCoreLocking">The locking behavior.</param>
public class TesserafinDbContext(DbContextOptions<TesserafinDbContext> options, ILogger<TesserafinDbContext> logger, ITesserafinDatabaseProvider reefinDatabaseProvider, IEntityFrameworkCoreLockingBehavior entityFrameworkCoreLocking) : DbContext(options)
{
    /// <summary>
    ...
    /// <summary>
    /// Repository for global::Tesserafin.Data.Entities.RatingSource - This is the entity to
    ...
    {
        reefinDatabaseProvider.OnModelCreating(modelBuilder);
        base.OnModelCreating(modelBuilder);

        // Configuration for each entity is in its own class inside 'ModelConfiguration'.
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(TesserafinDbContext).Assembly);
    }

    /// <inheritdoc />
    protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
    {
        reefinDatabaseProvider.ConfigureConventions(configurationBuilder);
