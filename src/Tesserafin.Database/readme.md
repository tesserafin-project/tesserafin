...
in the event that you get the error: `System.UnauthorizedAccessException: Access to the path '/src/Tesserafin.Database' is denied.` you have to restore as sudo and then run `ef migrations` as sudo too.
