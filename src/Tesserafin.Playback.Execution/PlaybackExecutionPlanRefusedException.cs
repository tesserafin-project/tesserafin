...
/// <summary>
/// Thrown by <see cref="PlaybackExecutionPlanBuilder.Build(Tesserafin.Playback.Decision.PlaybackDecision)"/>
...
/// so callers - most notably <c>Tesserafin.MediaEncoding.Playback.IPlaybackExecutionPlanResolver</c>, which
