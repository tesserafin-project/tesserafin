...
/// </remarks>
public class PeopleRepository(IDbContextFactory<TesserafinDbContext> dbProvider, IItemTypeLookup itemTypeLookup) : IPeopleRepository
{
    private readonly IDbContextFactory<TesserafinDbContext> _dbProvider = dbProvider;
    ...
    private IQueryable<People> TranslateQuery(IQueryable<People> query, TesserafinDbContext context, InternalPeopleQuery filter)
    {
