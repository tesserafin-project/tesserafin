...
namespace Tesserafin.Server.Implementations.Item;

public sealed partial class BaseItemRepository
{
    /// <inheritdoc />
    public IQueryable<BaseItemEntity> PrepareItemQuery(TesserafinDbContext context, InternalItemsQuery filter)
    {
    ...
    private IQueryable<BaseItemEntity> ApplyQueryFilter(IQueryable<BaseItemEntity> dbQuery, TesserafinDbContext context, InternalItemsQuery filter)
    {
    ...
    private IQueryable<BaseItemEntity> ApplyGroupingFilter(TesserafinDbContext context, IQueryable<BaseItemEntity> dbQuery, InternalItemsQuery filter)
    {
    ...
    /// <inheritdoc />
    public IQueryable<BaseItemEntity> ApplyOrder(IQueryable<BaseItemEntity> query, InternalItemsQuery filter, TesserafinDbContext context)
    {
    ...
    /// <inheritdoc />
    public IQueryable<Guid> GetFullyPlayedFolderIdsQuery(TesserafinDbContext context, IQueryable<Guid> folderIds, User user)
    {
