...
public sealed partial class BaseItemRepository
{
    ...
    private IReadOnlyList<BaseItemDto> GetLatestTvShowItems(TesserafinDbContext context, IQueryable<BaseItemEntity> baseQuery, InternalItemsQuery filter, int? limit)
    {
