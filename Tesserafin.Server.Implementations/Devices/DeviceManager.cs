...
namespace Tesserafin.Server.Implementations.Devices
{
    ...
    public class DeviceManager : IDeviceManager
    {
        ...
        public DeviceManager(IDbContextFactory<TesserafinDbContext> dbProvider, IUserManager userManager)
        {
