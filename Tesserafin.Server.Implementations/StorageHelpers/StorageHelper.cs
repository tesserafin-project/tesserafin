...
namespace Tesserafin.Server.Implementations.StorageHelpers;

/// <summary>
/// Contains methods to help with checking for storage and returning storage data for reefin folders.
/// </summary>
public static class StorageHelper
{
    ...
    /// <summary>
    /// Tests the available storage capacity on the reefin paths with estimated minimum values.
    /// </summary>
