...
using Tesserafin.Data.Queries;
using Tesserafin.Database.Implementations;
using Tesserafin.Extensions;

namespace Tesserafin.Server.Implementations.Security
{
    public class AuthorizationContext : IAuthorizationContext
    {
        private readonly IDbContextFactory<TesserafinDbContext> _reefinDbProvider;
        ...
        public AuthorizationContext(
            IDbContextFactory<TesserafinDbContext> reefinDb,
            IUserManager userManager,
            IDeviceManager deviceManager,
            IServerApplicationHost serverApplicationHost,
            IServerConfigurationManager configurationManager)
        {
            _reefinDbProvider = reefinDb;
            ...
            IQueryCollection queryString)
        {
            ...
            var dbContext = await _reefinDbProvider.CreateDbContextAsync().ConfigureAwait(false);
