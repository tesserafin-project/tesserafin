...
using Tesserafin.Controller.SyncPlay.PlaybackRequests;
using Tesserafin.Controller.SyncPlay.Requests;
...
public class SyncPlayController : BaseTesserafinApiController
{
