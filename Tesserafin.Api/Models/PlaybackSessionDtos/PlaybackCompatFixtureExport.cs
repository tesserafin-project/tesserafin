...
/// built from a real, retained <see cref="Tesserafin.MediaEncoding.Playback.ShadowDiagnosticRecord"/> by
...
/// <see cref="Tesserafin.Playback.Decision"/> records: the fixture schema's <c>constraints</c> object has
