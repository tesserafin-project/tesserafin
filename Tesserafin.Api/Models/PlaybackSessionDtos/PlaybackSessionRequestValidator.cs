...
/// reaches the TEMPORARY <c>Tesserafin.Playback.Dlna.ReverseDlnaAdapter</c> or the legacy pipeline
/// (PR112b).
/// </summary>
/// <remarks>
/// Tesserafin.Api has no validation-attribute or filter pipeline (no FluentValidation,
...
/// <c>Tesserafin.Api.Middleware.ExceptionMiddleware</c> maps to 400 automatically - the same pattern this
/// controller already uses for 404 (<c>ResourceNotFoundException</c>, uncaught). This only validates
/// what is actually verifiable from the <see cref="Tesserafin.Playback.Decision"/> vocabulary itself:
