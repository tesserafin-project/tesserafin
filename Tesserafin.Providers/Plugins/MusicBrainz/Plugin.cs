...
using Tesserafin.Controller.Plugins;
...
public class Plugin : BasePlugin<PluginConfiguration>, IHasWebPages, IHasEmbeddedImage, IDisposable
{
        ...
        : base(applicationPaths, xmlSerializer)
    {
        ...
        // TODO: Change this to "TesserafinMusicBrainzPlugin" once we take it out of the server repo.
    ...
    public override string ConfigurationFileName => "Tesserafin.Plugin.MusicBrainz.xml";
