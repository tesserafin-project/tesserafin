...
using Tesserafin.Providers.Plugins.ListenBrainz.Configuration;

namespace Tesserafin.Providers.Plugins.ListenBrainz;
...
public class ListenBrainzPlugin : BasePlugin<PluginConfiguration>, IHasWebPages, IHasEmbeddedImage
{
    ...
    /// <inheritdoc />
    public override string ConfigurationFileName => "Tesserafin.Plugin.ListenBrainz.xml";
