...
namespace Tesserafin.Providers.MediaInfo
{
    public class FFProbeVideoInfo
    {
            ...
            where T : Video
        {
            ...
            Tesserafin.Model.MediaInfo.MediaInfo? mediaInfoResult = null;
        ...
        private Task<Tesserafin.Model.MediaInfo.MediaInfo> GetMediaInfo(
            Video item,
            CancellationToken cancellationToken)
        {
            cancellationToken.ThrowIfCancellationRequested();
        ...
        protected async Task Fetch(
            Video video,
            CancellationToken cancellationToken,
            Tesserafin.Model.MediaInfo.MediaInfo? mediaInfo,
        ...
        private void FetchEmbeddedInfo(Video video, Tesserafin.Model.MediaInfo.MediaInfo data, MetadataRefreshOptions refreshOptions, LibraryOptions libraryOptions)
        {
        ...
        private void FetchPeople(Video video, Tesserafin.Model.MediaInfo.MediaInfo data, MetadataRefreshOptions options)
        {
            if (video.IsLocked
