...
using Tesserafin.Naming.ExternalFiles;
...
namespace Tesserafin.Providers.MediaInfo
{
    ...
    public abstract class MediaInfoResolver
    {
        ...
        private Task<Tesserafin.Model.MediaInfo.MediaInfo> GetMediaInfo(string path, DlnaProfileType type, CancellationToken cancellationToken)
        {
