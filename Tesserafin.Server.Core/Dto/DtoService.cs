...
using Book = Tesserafin.Controller.Entities.Book;
using Episode = Tesserafin.Controller.Entities.TV.Episode;
using Movie = Tesserafin.Controller.Entities.Movies.Movie;
using MusicAlbum = Tesserafin.Controller.Entities.Audio.MusicAlbum;
using Person = Tesserafin.Controller.Entities.Person;
using Photo = Tesserafin.Controller.Entities.Photo;
using Season = Tesserafin.Controller.Entities.TV.Season;
using Series = Tesserafin.Controller.Entities.TV.Series;

namespace Tesserafin.Server.Core.Dto
{
