    ...
    public class SeriesResolver : GenericFolderResolver<Series>
    {
        ...
        protected override Series Resolve(ItemResolveArgs args)
        {
            if (args.IsDirectory)
            {
                ...
                var seriesInfo = Tesserafin.Naming.TV.SeriesResolver.Resolve(_namingOptions, args.Path);
            ...
            foreach (var child in fileSystemChildren)
            {
                ...
                else
                {
                    ...
                    if (VideoResolver.IsVideoFile(path, _namingOptions))
                    {
                        ...
                        var episodeResolver = new Tesserafin.Naming.TV.EpisodeResolver(namingOptions);
