...
using Tesserafin.Naming.Audio;
using Tesserafin.Naming.AudioBook;
using Tesserafin.Naming.Common;
using Tesserafin.Naming.Video;

namespace Tesserafin.Server.Core.Library.Resolvers.Audio
{
    /// <summary>
    /// Class AudioResolver.
    /// </summary>
    public class AudioResolver : ItemResolver<Tesserafin.Controller.Entities.Audio.Audio>, IMultiItemResolver
    {
            ...
            IDirectoryService directoryService)
        {
            ...
            if (result is not null)
            {
                ...
                {
                    SetInitialItemValues((Tesserafin.Controller.Entities.Audio.Audio)item, null);
                }
            }
        ...
        protected override Tesserafin.Controller.Entities.Audio.Audio Resolve(ItemResolveArgs args)
        {
            ...
            if (AudioFileParser.IsAudioFile(args.Path, _namingOptions))
            {
                ...
                Tesserafin.Controller.Entities.Audio.Audio item = null;
                ...
                {
                    item = new Tesserafin.Controller.Entities.Audio.Audio();
                }
