...
namespace Tesserafin.Server.Core.Localization
{
    /// <summary>
    ...
    public class LocalizationManager : ILocalizationManager
    {
        ...
        private const string RatingsPath = "Tesserafin.Server.Core.Localization.Ratings.";
        private const string CulturesPath = "Tesserafin.Server.Core.Localization.iso6392.txt";
        private const string CountriesPath = "Tesserafin.Server.Core.Localization.countries.json";
        private const string CoreResourcePrefix = "Tesserafin.Server.Core.Localization.Core.";
        ...
        private static readonly (IReadOnlyList<LocalizationOption> Options, FrozenDictionary<string, string> Bcp47ToTesserafinMap) _localizationData = BuildLocalizationData();
        ...
        // and used as CurrentUICulture.Name) to Reefin's underscore-based resource file codes.
        // Built reflexively from the resource file scan so both directions stay in sync.
        private static readonly FrozenDictionary<string, string> _bcp47ToTesserafinMap = _localizationData.Bcp47ToTesserafinMap;
        ...
        /// <summary>
        /// Resolves a Reefin resource culture code (which may use underscores, e.g. <c>es_419</c>)
        ...
        public string GetLocalizedString(string phrase, string culture)
        {
            ...
            // Normalize BCP-47 hyphenated codes to Reefin's underscore-based codes
            if (_bcp47ToTesserafinMap.TryGetValue(culture, out var mapped))
            {
                culture = mapped;
            }
        ...
        private static (IReadOnlyList<LocalizationOption> Options, FrozenDictionary<string, string> Bcp47ToTesserafinMap) BuildLocalizationData()
        {
            ...
            foreach (var resource in _assembly.GetManifestResourceNames())
            {
                ...
                // Record the BCP-47 → Reefin mapping for any resource file using underscores.
