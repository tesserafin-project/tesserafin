...
using Tesserafin.Common.Events;
...
using Tesserafin.Controller.LibraryTaskScheduler;
...
using Tesserafin.LocalMetadata.Savers;
using Tesserafin.MediaEncoding.BdInfo;
using Tesserafin.MediaEncoding.Hls.Playlist;
using Tesserafin.MediaEncoding.Playback;
using Tesserafin.MediaEncoding.Subtitles;
...
using Tesserafin.Networking.Manager;
using Tesserafin.Networking.Udp;
using Tesserafin.Photos;
using Tesserafin.Playback.Engine;
using Tesserafin.Playback.Shadow;
using Tesserafin.Providers.Books;
using Tesserafin.Providers.Books.ComicBookInfo;
using Tesserafin.Providers.Books.ComicInfo;
using Tesserafin.Providers.Lyric;
using Tesserafin.Providers.Manager;
using Tesserafin.Providers.Plugins.ListenBrainz;
using Tesserafin.Providers.Plugins.ListenBrainz.Api;
using Tesserafin.Providers.Plugins.Tmdb;
using Tesserafin.Providers.Plugins.Tmdb.Movies;
using Tesserafin.Providers.Plugins.Tmdb.TV;
using Tesserafin.Providers.Subtitles;
using Tesserafin.Server.Core.Chapters;
using Tesserafin.Server.Core.Collections;
using Tesserafin.Server.Core.Configuration;
using Tesserafin.Server.Core.Cryptography;
using Tesserafin.Server.Core.Data;
using Tesserafin.Server.Core.Devices;
using Tesserafin.Server.Core.Dto;
using Tesserafin.Server.Core.HttpServer.Security;
using Tesserafin.Server.Core.IO;
using Tesserafin.Server.Core.Library;
using Tesserafin.Server.Core.Library.Search;
using Tesserafin.Server.Core.Library.SimilarItems;
using Tesserafin.Server.Core.Localization;
using Tesserafin.Server.Core.Playlists;
using Tesserafin.Server.Core.Plugins;
using Tesserafin.Server.Core.QuickConnect;
using Tesserafin.Server.Core.ScheduledTasks;
using Tesserafin.Server.Core.Serialization;
using Tesserafin.Server.Core.Session;
using Tesserafin.Server.Core.Sorting;
...
using Tesserafin.XbmcMetadata.Providers;
using static Tesserafin.Controller.Extensions.ConfigurationExtensions;
using IConfigurationManager = Tesserafin.Common.Configuration.IConfigurationManager;
using WebSocketManager = Tesserafin.Server.Core.HttpServer.WebSocketManager;
...
namespace Tesserafin.Server.Core
{
    ...
    public abstract class ApplicationHost : IServerApplicationHost, IDisposable
    {
        ...
        protected virtual void RegisterServices(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IMediaEncoder, Tesserafin.MediaEncoding.Encoder.MediaEncoder>();
            ...
            serviceCollection.AddSingleton<IAttachmentExtractor, Tesserafin.MediaEncoding.Attachments.AttachmentExtractor>();
            ...
            serviceCollection.AddSingleton<IPlaybackSessionManager>(provider => new PlaybackSessionManager(
                ...
                // Tesserafin.Server's Startup, which does not exist in every host that builds this
        ...
        protected IEnumerable<Assembly> GetComposablePartAssemblies()
        {
            ...
            // MediaEncoding
            yield return typeof(Tesserafin.MediaEncoding.Encoder.MediaEncoder).Assembly;
