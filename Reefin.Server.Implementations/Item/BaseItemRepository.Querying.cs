...
public sealed partial class BaseItemRepository
{
    ...
    private IReadOnlyList<BaseItemDto> GetLatestTvShowItems(ReefinDbContext context, IQueryable<BaseItemEntity> baseQuery, InternalItemsQuery filter, int? limit)
    {
