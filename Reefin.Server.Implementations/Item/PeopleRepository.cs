...
/// </remarks>
public class PeopleRepository(IDbContextFactory<ReefinDbContext> dbProvider, IItemTypeLookup itemTypeLookup) : IPeopleRepository
{
    private readonly IDbContextFactory<ReefinDbContext> _dbProvider = dbProvider;
    ...
    private IQueryable<People> TranslateQuery(IQueryable<People> query, ReefinDbContext context, InternalPeopleQuery filter)
    {
