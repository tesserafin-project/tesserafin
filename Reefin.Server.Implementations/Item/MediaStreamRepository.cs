...
public class MediaStreamRepository : IMediaStreamRepository
{
    ...
    public MediaStreamRepository(IDbContextFactory<ReefinDbContext> dbProvider, IServerApplicationHost serverApplicationHost, ILocalizationManager localization)
    {
