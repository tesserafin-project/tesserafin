...
{
    /// <inheritdoc />
    public IQueryable<BaseItemEntity> PrepareItemQuery(ReefinDbContext context, InternalItemsQuery filter)
    {
    ...
    private IQueryable<BaseItemEntity> ApplyQueryFilter(IQueryable<BaseItemEntity> dbQuery, ReefinDbContext context, InternalItemsQuery filter)
    {
    ...
    private IQueryable<BaseItemEntity> ApplyGroupingFilter(ReefinDbContext context, IQueryable<BaseItemEntity> dbQuery, InternalItemsQuery filter)
    {
    ...
    /// <inheritdoc />
    public IQueryable<BaseItemEntity> ApplyOrder(IQueryable<BaseItemEntity> query, InternalItemsQuery filter, ReefinDbContext context)
    {
    ...
    /// <inheritdoc />
    public IQueryable<Guid> GetFullyPlayedFolderIdsQuery(ReefinDbContext context, IQueryable<Guid> folderIds, User user)
    {
