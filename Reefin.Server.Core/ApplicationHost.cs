...
using Reefin.Controller.Subtitles;
...
using Reefin.Providers.Plugins.ListenBrainz;
using Reefin.Providers.Plugins.ListenBrainz.Api;
using Reefin.Providers.Plugins.Tmdb;
using Reefin.Providers.Plugins.Tmdb.Movies;
using Reefin.Providers.Plugins.Tmdb.TV;
using Reefin.Providers.Subtitles;
using Reefin.Server.Core.Chapters;
using Reefin.Server.Core.Collections;
using Reefin.Server.Core.Configuration;
using Reefin.Server.Core.Cryptography;
using Reefin.Server.Core.Data;
using Reefin.Server.Core.Devices;
using Reefin.Server.Core.Dto;
using Reefin.Server.Core.HttpServer.Security;
using Reefin.Server.Core.IO;
using Reefin.Server.Core.Library;
using Reefin.Server.Core.Library.Search;
using Reefin.Server.Core.Library.SimilarItems;
...
using Reefin.Server.Implementations.FullSystemBackup;
using Reefin.Server.Implementations.Item;
using Reefin.Server.Implementations.MediaSegments;
using Reefin.Server.Implementations.SystemBackupService;
using Reefin.XbmcMetadata.Providers;
...
using WebSocketManager = Reefin.Server.Core.HttpServer.WebSocketManager;
...
namespace Reefin.Server.Core
{
    ...
    public abstract class ApplicationHost : IServerApplicationHost, IDisposable
    {
        ...
        protected virtual void RegisterServices(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IItemHierarchyService, ItemHierarchyService>();
