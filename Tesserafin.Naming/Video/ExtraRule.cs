...
using MediaType = Tesserafin.Naming.Common.MediaType;

namespace Tesserafin.Naming.Video
{
    /// <summary>
    /// A rule used to match a file path with an <see cref="Tesserafin.Model.Entities.ExtraType"/>.
    /// </summary>
