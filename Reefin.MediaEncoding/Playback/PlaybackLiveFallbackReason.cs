...
/// served from the v2 <see cref="Reefin.Playback.Execution.PlaybackExecutionPlan"/>, for a session
...
public enum PlaybackLiveFallbackReason
{
    ...
    /// canary cohort, the effective <see cref="Reefin.Model.Configuration.PlaybackEngineMode"/> is
    ...
    /// <summary>
    /// The resolved plan's <see cref="Reefin.Playback.Execution.PlaybackExecutionPlan.SourceId"/> did
    ...
    /// <see cref="Reefin.Controller.MediaEncoding.EncodingHelper.CanStreamCopyVideo"/>'s missing
    ...
    /// membership or plan executability - the effective <see cref="Reefin.Model.Configuration.PlaybackEngineMode"/>
    ...
    /// <summary>
    /// <see cref="Reefin.Playback.Dlna.PlaybackExecutionPlanAdapter.ToStreamInfo"/> threw while
