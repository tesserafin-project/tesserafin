...
/// <see cref="Reefin.Playback.Shadow.ShadowMetricsSnapshot"/>'s shape and role.
/// </summary>
    ...
    long TranscodeStartFailuresV2)
{
    ...
    /// <summary>
    /// Gets the number of requests that reached <see cref="Reefin.Playback.Dlna.PlaybackExecutionPlanAdapter.ToStreamInfo"/>
    ...
    /// yet - matches <see cref="Reefin.Model.Configuration.PlaybackStopThresholdOptions.AdapterErrorRateThreshold"/>'s
