...
/// <see cref="Reefin.Playback.Execution.PlaybackExecutionPlan"/>, or why it fell back to the legacy
...
/// <see langword="true"/> when the response was built by <see cref="Reefin.Playback.Dlna.PlaybackExecutionPlanAdapter.ToStreamInfo"/>
