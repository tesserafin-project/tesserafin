...
internal class CodeMigration(Type migrationType, ReefinMigrationAttribute metadata, ReefinMigrationBackupAttribute? migrationBackupAttribute)
{
    public Type MigrationType { get; } = migrationType;

    public ReefinMigrationAttribute Metadata { get; } = metadata;

    public ReefinMigrationBackupAttribute? BackupRequirements { get; set; } = migrationBackupAttribute;
