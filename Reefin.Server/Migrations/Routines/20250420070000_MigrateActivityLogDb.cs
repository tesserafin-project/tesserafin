...
#pragma warning disable CS0618 // Type or member is obsolete
    [ReefinMigration("2025-04-20T07:00:00", nameof(MigrateActivityLogDb), "3793eb59-bc8c-456c-8b9f-bd5a62a42978")]
...
#pragma warning restore CS0618 // Type or member is obsolete
    {
        ...
        public MigrateActivityLogDb(ILogger<MigrateActivityLogDb> logger, IServerApplicationPaths paths, IDbContextFactory<ReefinDbContext> provider)
        {
            _logger = logger;
            _provider = provider;
            _paths = paths;
