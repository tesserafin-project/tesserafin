...
using LinkedChildType = Reefin.Database.Implementations.Entities.LinkedChildType;
...
/// </summary>
[ReefinMigration("2026-01-13T12:00:00", nameof(MigrateLinkedChildren))]
...
internal class MigrateLinkedChildren : IDatabaseMigrationRoutine
{
    ...
    private void CleanupWrongTypeAlternateVersions(ReefinDbContext context)
    {
    ...
    private void CleanupOrphanedAlternateVersionBaseItems(ReefinDbContext context)
    {
    ...
    private void CleanupItemsFromDeletedLibraries(ReefinDbContext context)
    {
    ...
    private void CleanupStaleFileEntries(ReefinDbContext context)
    {
    ...
    private void CleanupOrphanedLinkedChildren(ReefinDbContext context)
    {
