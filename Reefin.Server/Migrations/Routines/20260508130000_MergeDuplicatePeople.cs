...
/// </summary>
[ReefinMigration("2026-05-08T13:00:00", nameof(MergeDuplicatePeople))]
...
public class MergeDuplicatePeople : IAsyncMigrationRoutine
{
    ...
    private async Task MergePersonBaseItemsAsync(ReefinDbContext context, CancellationToken cancellationToken)
    {
    ...
    private async Task MergePeoplesRowsAsync(ReefinDbContext context, CancellationToken cancellationToken)
    {
