...
/// </summary>
[ReefinMigration("2025-06-20T18:00:00", nameof(FixDates))]
public class FixDates : IAsyncMigrationRoutine
{
    ...
    /// <param name="dbProvider">Instance of the <see cref="IDbContextFactory{ReefinDbContext}"/> interface.</param>
    public FixDates(
    ...
    private async Task FixBaseItemsAsync(ReefinDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
    ...
    private async Task FixChaptersAsync(ReefinDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
    ...
    private async Task FixBaseItemImageInfos(ReefinDbContext context, Stopwatch sw, CancellationToken cancellationToken)
    {
        int itemCount = 0;
