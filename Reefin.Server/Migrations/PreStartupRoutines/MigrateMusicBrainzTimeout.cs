...
[ReefinMigration("2025-04-20T02:00:00", nameof(MigrateMusicBrainzTimeout), "A6DCACF4-C057-4Ef9-80D3-61CEF9DDB4F0", Stage = Stages.ReefinMigrationStageTypes.PreInitialisation)]
...
#pragma warning restore CS0618 // Type or member is obsolete
{
    ...
    public void Perform()
    {
        string path = Path.Combine(_applicationPaths.PluginConfigurationsPath, "Reefin.Plugin.MusicBrainz.xml");
        if (!File.Exists(path))
        {
