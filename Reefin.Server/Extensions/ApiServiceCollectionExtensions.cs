...
using Reefin.Api.Auth.AnonymousLanAccessPolicy;
using Reefin.Api.Auth.DefaultAuthorizationPolicy;
using Reefin.Api.Auth.FirstTimeSetupPolicy;
using Reefin.Api.Auth.LocalAccessOrRequiresElevationPolicy;
using Reefin.Api.Auth.SyncPlayAccessPolicy;
using Reefin.Api.Auth.UserPermissionPolicy;
...
using Reefin.Server.Filters;
using Swashbuckle.AspNetCore.Swagger;
using Swashbuckle.AspNetCore.SwaggerGen;
using AuthenticationSchemes = Reefin.Api.Constants.AuthenticationSchemes;
...
namespace Reefin.Server.Extensions
{
    ...
    public static class ApiServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddReefinApiAuthorization(this IServiceCollection serviceCollection)
        {
        ...
        /// <param name="serviceCollection">The service collection.</param>
        /// <returns>The updated service collection.</returns>
        public static IServiceCollection AddReefinApiSwagger(this IServiceCollection serviceCollection)
        {
