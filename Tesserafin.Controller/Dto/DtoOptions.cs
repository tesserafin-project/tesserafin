...
namespace Tesserafin.Controller.Dto
{
    /// <summary>
    /// Options that control which fields and images are populated when building a <see cref="Tesserafin.Model.Dto.BaseItemDto"/>.
    /// </summary>
