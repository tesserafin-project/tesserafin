...
namespace Tesserafin.Playback.Contract.Scan.Tests;
...
/// than referencing Tesserafin.Api) so the scanner is tested in isolation from the web stack; a separate
/// Tesserafin.Api test proves the provider sources these exact names from the binder's own
/// <c>JsonTypeInfo</c>.
/// </summary>
