...
public sealed class PlaybackContractScannerBanTests
{
    ...
    {
        var banFile = Path.Combine(RepoRoot(), "src", "Tesserafin.Playback.Contract.Scan", "BannedSymbols.txt");
    ...
    private static string RepoRoot()
    {
        ...
        while (dir is not null && !File.Exists(Path.Combine(dir.FullName, "Tesserafin.sln")))
        {
            dir = dir.Parent;
        }
