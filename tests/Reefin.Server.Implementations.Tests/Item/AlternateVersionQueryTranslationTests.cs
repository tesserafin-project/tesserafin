...
public sealed class AlternateVersionQueryTranslationTests : IDisposable
{
    ...
    private readonly DbContextOptions<ReefinDbContext> _dbOptions;
    ...
    public AlternateVersionQueryTranslationTests()
    {
        ...
        _dbOptions = new DbContextOptionsBuilder<ReefinDbContext>()
    ...
    private static (Guid UserId, Guid PrimaryId, Guid VersionId, Guid OtherId) Seed(ReefinDbContext ctx)
    {
    ...
    private static (Guid UserId, Guid PrimaryId, Guid VersionAId, Guid VersionBId) SeedTiedVersions(ReefinDbContext ctx)
    {
        var user = new User("test", "auth-provider", "reset-provider");
        ctx.Users.Add(user);
    ...
    private ReefinDbContext CreateDbContext()
    {
