...
/// <summary>
/// Parity tests between the delegated <see cref="Reefin.Server.Core.Library.LibraryManager"/>
...
/// <see cref="Reefin.Server.Core.Library.ItemLookupService"/> instance backs both
/// <see cref="IItemLookupService"/> and the internal <see cref="Reefin.Server.Core.Library.IItemCacheStore"/>
/// port, a single, shared, real <see cref="Reefin.Server.Core.Library.ItemStore"/> instance is
/// registered for both the concrete type and <see cref="IItemStore"/>, and - new in PR106b - a
/// single, shared, real <see cref="Reefin.Server.Core.Library.UserViewFactory"/> instance (built
...
public class LibraryManagerUserViewFactoryTests
{
    ...
    private readonly Reefin.Server.Core.Library.UserViewFactory _userViewFactory;
    ...
    public LibraryManagerUserViewFactoryTests()
    {
        ...
        _userViewFactory = new Reefin.Server.Core.Library.UserViewFactory(
            _itemLookupService,
            _itemStore,
            _configurationManagerMock.Object,
    ...
    {
        Reefin.Controller.Entities.BaseItem.ConfigurationManager = _configurationManagerMock.Object;
        Reefin.Controller.Entities.BaseItem.LibraryManager = _libraryManager;
    ...
    public void GetNamedView_ExistingViewAlreadyRefreshed_LazyProviderManagerValueNeverEvaluated()
    {
        ...
        var factoryWithThrowingProvider = new Reefin.Server.Core.Library.UserViewFactory(
            _itemLookupService,
            _itemStore,
            _configurationManagerMock.Object,
            _fileSystemMock.Object,
    ...
    public void GetShadowView_NewView_LazyProviderManagerValueEvaluatedOnlyAfterSaveAndRegister()
    {
        ...
        var factory = new Reefin.Server.Core.Library.UserViewFactory(
    ...
    /// <summary>
    /// Hand-written internal <see cref="Reefin.Server.Core.Library.IItemCacheStore"/> double, purely
    /// to record when <c>Register</c> runs relative to <c>SaveItems</c> and
    /// <c>Lazy&lt;IProviderManager&gt;.Value</c> - see <see cref="Reefin.Server.Implementations.Tests.Library.ItemStoreTests"/>'s
    /// own <c>FakeItemCacheStore</c> remarks for why a hand-written double is used here instead of Moq.
    /// </summary>
    private sealed class OrderTrackingItemCacheStore : Reefin.Server.Core.Library.IItemCacheStore
    {
