...
/// <summary>
/// Cross-checks between <see cref="Reefin.Server.Core.Library.ItemStore"/> (PR106a) and the real
/// <see cref="Reefin.Server.Core.Library.LibraryManager"/> it is injected into: parity of
...
/// port, and a single, shared, real <see cref="Reefin.Server.Core.Library.ItemStore"/> instance
...
public class LibraryManagerItemStoreTests
{
    ...
    public void DiWiring_LibraryManagerOnlyRelaysFromInjectedItemStoreSingleton_NotFromADifferentInstance()
    {
        ...
        var otherItemStore = new Reefin.Server.Core.Library.ItemStore(
            _persistenceServiceMock.Object,
            _itemLookupService,
            _configurationManagerMock.Object,
            NullLogger<Reefin.Server.Core.Library.ItemStore>.Instance);
