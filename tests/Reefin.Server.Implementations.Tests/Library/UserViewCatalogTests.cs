...
/// <see cref="Reefin.Server.Implementations.Tests.Library.LibraryManager.LibraryManagerStaticStateFixture"/>).
/// </remarks>
...
public sealed class UserViewCatalogTests
{
    ...
    private static IServerConfigurationManager MakeConfig(bool enableFolderView = false)
    {
        ...
        Reefin.Controller.Entities.BaseItem.ConfigurationManager = mock.Object;
        return mock.Object;
    }
