...
/// (c) declared in the <c>Tesserafin.Playback.Contract.Diagnostics</c> assembly itself - in which case
...
/// <c>src/Tesserafin.Playback.Contract.Diagnostics/BannedSymbols.txt</c>, which fails the BUILD (RS0030)
