...
using Tesserafin.Server.Core.Library.Resolvers.TV;
using Xunit;
...
namespace Tesserafin.Server.Implementations.Tests.Library
{
    public class EpisodeResolverTest
    {
        ...
        public void Resolve_GivenVideoInExtrasSeriesFolder_ResolvesToEpisode()
        {
            ...
            // https://github.com/jellyfin/jellyfin/blob/ab0cff8556403e123642dc9717ba778329554634/Tesserafin.Server.Core/Library/Resolvers/BaseVideoResolver.cs#L48
