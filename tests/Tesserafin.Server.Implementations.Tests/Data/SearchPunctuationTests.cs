...
namespace Tesserafin.Server.Implementations.Tests.Data
{
    public class SearchPunctuationTests
    {
        ...
        {
            var appHost = new Mock<Tesserafin.Controller.IServerApplicationHost>();
            ...
            configSection
                .SetupGet(x => x[It.Is<string>(s => s == Tesserafin.Controller.Extensions.ConfigurationExtensions.SqliteCacheSizeKey)])
                .Returns("0");
            var config = new Mock<IConfiguration>();
            config
                .Setup(x => x.GetSection(It.Is<string>(s => s == Tesserafin.Controller.Extensions.ConfigurationExtensions.SqliteCacheSizeKey)))
