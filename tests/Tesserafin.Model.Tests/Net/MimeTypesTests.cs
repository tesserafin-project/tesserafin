...
namespace Tesserafin.Model.Tests.Net
{
    public class MimeTypesTests
    {
        ...
        {
            Assert.Equal(expectedResult, Tesserafin.Model.Net.MimeTypes.GetMimeType(input, null));
        }
        ...
        {
            Assert.Equal(expectedResult, Tesserafin.Model.Net.MimeTypes.ToExtension(input));
        }
    }
}
