...
/// <c>Tesserafin.Api.Middleware.ExceptionMiddleware</c>) for every declared-but-unusable inconsistency
/// the <see cref="Tesserafin.Playback.Decision"/> vocabulary can actually express.
/// </summary>
