...
namespace Tesserafin.Api.Tests.Auth
{
    public class CustomAuthenticationHandlerTests
    {
        private readonly IFixture _fixture;

        private readonly Mock<IAuthService> _reefinAuthServiceMock;
        ...
        public CustomAuthenticationHandlerTests()
        {
            ...
            _reefinAuthServiceMock = _fixture.Freeze<Mock<IAuthService>>();
