...
namespace Reefin.Server.Integration.Tests
{
    ...
    /// </summary>
    public class ReefinApplicationFactory : WebApplicationFactory<Startup>
    {
        ...
        /// <summary>
        /// Initializes static members of the <see cref="ReefinApplicationFactory"/> class.
        /// </summary>
        static ReefinApplicationFactory()
        {
