...
{
    public sealed class ActivityLogControllerTests : IClassFixture<ReefinApplicationFactory>
    {
        private readonly ReefinApplicationFactory _factory;
        private static string? _accessToken;

        public ActivityLogControllerTests(ReefinApplicationFactory factory)
        {
            _factory = factory;
        }
