...
public sealed class LibraryStructureControllerTests : IClassFixture<ReefinApplicationFactory>
{
    private readonly ReefinApplicationFactory _factory;
    private readonly JsonSerializerOptions _jsonOptions = JsonDefaults.Options;
    private static string? _accessToken;

    public LibraryStructureControllerTests(ReefinApplicationFactory factory)
    {
        _factory = factory;
    }
