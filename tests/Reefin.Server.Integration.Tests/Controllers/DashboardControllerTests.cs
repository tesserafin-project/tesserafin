...
{
    public sealed class DashboardControllerTests : IClassFixture<ReefinApplicationFactory>
    {
        private readonly ReefinApplicationFactory _factory;
        private readonly JsonSerializerOptions _jsonOptions = JsonDefaults.Options;
        private static string? _accessToken;

        public DashboardControllerTests(ReefinApplicationFactory factory)
        {
            _factory = factory;
        }
        ...
        public async Task GetDashboardConfigurationPage_ExistingPage_CorrectPage()
        {
            ...
            StreamReader reader = new StreamReader(typeof(TestPlugin).Assembly.GetManifestResourceStream("Reefin.Server.Integration.Tests.TestPage.html")!);
