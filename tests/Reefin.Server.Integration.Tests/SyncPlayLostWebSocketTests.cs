...
public sealed class SyncPlayLostWebSocketTests : IClassFixture<ReefinApplicationFactory>
{
    private readonly ReefinApplicationFactory _factory;

    public SyncPlayLostWebSocketTests(ReefinApplicationFactory factory)
    {
        _factory = factory;
    }
