...
namespace Reefin.Server.Integration.Tests.Middleware
{
    public sealed class RobotsRedirectionMiddlewareTests : IClassFixture<ReefinApplicationFactory>
    {
        private readonly ReefinApplicationFactory _factory;

        public RobotsRedirectionMiddlewareTests(ReefinApplicationFactory factory)
        {
            _factory = factory;
        }
