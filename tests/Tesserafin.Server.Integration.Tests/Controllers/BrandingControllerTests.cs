...
{
    public sealed class BrandingControllerTests : IClassFixture<TesserafinApplicationFactory>
    {
        private readonly TesserafinApplicationFactory _factory;

        public BrandingControllerTests(TesserafinApplicationFactory factory)
        {
            _factory = factory;
        }
