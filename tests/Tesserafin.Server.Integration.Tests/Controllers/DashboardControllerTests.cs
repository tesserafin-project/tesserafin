...
using Tesserafin.Api.Models;
using Tesserafin.Extensions.Json;
using Xunit;

namespace Tesserafin.Server.Integration.Tests.Controllers
{
    public sealed class DashboardControllerTests : IClassFixture<TesserafinApplicationFactory>
    {
        private readonly TesserafinApplicationFactory _factory;
        private readonly JsonSerializerOptions _jsonOptions = JsonDefaults.Options;
        private static string? _accessToken;

        public DashboardControllerTests(TesserafinApplicationFactory factory)
        {
            _factory = factory;
        }
        ...
        public async Task GetDashboardConfigurationPage_ExistingPage_CorrectPage()
        {
            ...
            StreamReader reader = new StreamReader(typeof(TestPlugin).Assembly.GetManifestResourceStream("Tesserafin.Server.Integration.Tests.TestPage.html")!);
