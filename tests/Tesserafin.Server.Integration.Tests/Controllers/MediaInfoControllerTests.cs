...
{
    public sealed class MediaInfoControllerTests : IClassFixture<TesserafinApplicationFactory>
    {
        private readonly TesserafinApplicationFactory _factory;
        private static string? _accessToken;

        public MediaInfoControllerTests(TesserafinApplicationFactory factory)
        {
            _factory = factory;
        }
