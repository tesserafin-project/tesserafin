...
public sealed class PluginsControllerTests : IClassFixture<TesserafinApplicationFactory>
{
    private readonly TesserafinApplicationFactory _factory;
    private static string? _accessToken;

    public PluginsControllerTests(TesserafinApplicationFactory factory)
    {
        _factory = factory;
    }
