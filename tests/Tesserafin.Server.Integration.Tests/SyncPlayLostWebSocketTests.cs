...
using Tesserafin.Api.Models.SyncPlayDtos;
...
public sealed class SyncPlayLostWebSocketTests : IClassFixture<TesserafinApplicationFactory>
{
    private readonly TesserafinApplicationFactory _factory;

    public SyncPlayLostWebSocketTests(TesserafinApplicationFactory factory)
    {
        _factory = factory;
    }
